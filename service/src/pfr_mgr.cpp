...
static constexpr const char* postcodeIface = "xyz.openbmc_project.State.Boot.Platform";
    ...
    conn(conn_)
{
    ...
    pfrPostcodeIface = server.add_interface(
        "/xyz/openbmc_project/pfr", postcodeIface);
